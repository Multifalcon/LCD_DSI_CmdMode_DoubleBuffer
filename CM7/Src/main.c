/**
  ******************************************************************************
  * @file    LCD_DSI/LCD_DSI_CmdMode_DoubleBuffer/CM7/Src/main.c
  * @author  MCD Application Team
  * @brief   This example describes how to configure and use LCD DSI in Adapted 
  *          command mode to display an image (320x240) using the STM32H7xx HAL API and BSP.
  *          The complete screen size is WVGA and oriented in mode landscape (800x480).
